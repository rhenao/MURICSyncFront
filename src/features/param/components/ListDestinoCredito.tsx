...
import type DestinoCredito from "../models/DestinoCredito.model";
import { MaterialReactTable, type MRT_ColumnDef } from "material-react-table";
import { Button, Card, Typography } from "@mui/material";

export default function ListDestinoCredito() {
  const { entidades, cargando } =
    useEntidades<DestinoCredito>("/DestinoCredito");

  const columns: MRT_ColumnDef<DestinoCredito>[] = [
    {
      accessorKey: "Codigo",
      header: "Código",
      size: 120,
