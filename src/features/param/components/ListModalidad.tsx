...
import type Modalidad from "../models/Modalidad.model";
import { MaterialReactTable, type MRT_ColumnDef } from "material-react-table";
import { Button, Card, Typography } from "@mui/material";

export default function ListModalidad() {
  const { entidades, cargando } = useEntidades<Modalidad>("/Modalidad");

  const columns: MRT_ColumnDef<Modalidad>[] = [
    {
      accessorKey: "Codigo",
      header: "Código",
      size: 120,
