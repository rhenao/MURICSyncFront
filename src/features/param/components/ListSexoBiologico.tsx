...
import type SexoBiologico from "../models/SexoBiologico.model";
import { MaterialReactTable, type MRT_ColumnDef } from "material-react-table";
import { Button, Card, Typography } from "@mui/material";

export default function ListSexoBiologico() {
  const { entidades, cargando } = useEntidades<SexoBiologico>("/SexoBiologico");

  const columns: MRT_ColumnDef<SexoBiologico>[] = [
    {
      accessorKey: "Codigo",
      header: "Código",
      size: 280,
