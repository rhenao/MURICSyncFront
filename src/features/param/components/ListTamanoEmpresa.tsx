...
import type TamanoEmpresa from "../models/TamanoEmpresa.model";
import { MaterialReactTable, type MRT_ColumnDef } from "material-react-table";
import { Button, Card, Typography } from "@mui/material";

export default function ListTamanoEmpresa() {
  const { entidades, cargando } = useEntidades<TamanoEmpresa>("/TamanoEmpresa");

  const columns: MRT_ColumnDef<TamanoEmpresa>[] = [
    {
      accessorKey: "Codigo",
      header: "Código",
      size: 120,
