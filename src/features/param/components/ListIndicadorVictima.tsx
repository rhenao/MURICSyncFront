...
import type IndicadorVictima from "../models/IndicadorVictima.model";
import { MaterialReactTable, type MRT_ColumnDef } from "material-react-table";
import { Button, Card, Typography } from "@mui/material";

export default function ListIndicadorVictima() {
  const { entidades, cargando } =
    useEntidades<IndicadorVictima>("/IndicadorVictima");

  const columns: MRT_ColumnDef<IndicadorVictima>[] = [
    {
      accessorKey: "Codigo",
      header: "Código",
      size: 120,
