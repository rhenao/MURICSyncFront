...
import type TipoConsolidacion from "../models/TipoConsolidacion.model";
import { MaterialReactTable, type MRT_ColumnDef } from "material-react-table";
import { Button, Card, Typography } from "@mui/material";

export default function ListTipoConsolidacion() {
  const { entidades, cargando } =
    useEntidades<TipoConsolidacion>("/TipoConsolidacion");

  const columns: MRT_ColumnDef<TipoConsolidacion>[] = [
    {
      accessorKey: "Codigo",
      header: "Código",
      size: 120,
