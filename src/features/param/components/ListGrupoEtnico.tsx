...
import type GrupoEtnico from "../models/GrupoEtnico.model";

export default function ListGrupoEtnico() {
  const { entidades, cargando } = useEntidades<GrupoEtnico>("/GrupoEtnico");

  const columns: MRT_ColumnDef<GrupoEtnico>[] = [
