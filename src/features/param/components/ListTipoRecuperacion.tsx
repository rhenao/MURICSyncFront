...
import type TipoRecuperacion from "../models/TipoRecuperacion.model";
import { MaterialReactTable, type MRT_ColumnDef } from "material-react-table";
import { Button, Card, Typography } from "@mui/material";

export default function ListTipoRecuperacion() {
  const { entidades, cargando } =
    useEntidades<TipoRecuperacion>("/TipoRecuperacion");

  const columns: MRT_ColumnDef<TipoRecuperacion>[] = [
    {
      accessorKey: "Codigo",
      header: "Código",
      size: 120,
