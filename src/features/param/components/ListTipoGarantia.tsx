...
import type TipoGarantia from "../models/TipoGarantia.model";
import { MaterialReactTable, type MRT_ColumnDef } from "material-react-table";
import { Button, Card, Typography } from "@mui/material";

export default function ListTipoGarantia() {
  const { entidades, cargando } = useEntidades<TipoGarantia>("/TipoGarantia");

  const columns: MRT_ColumnDef<TipoGarantia>[] = [
    {
      accessorKey: "Codigo",
      header: "Código",
      size: 120,
