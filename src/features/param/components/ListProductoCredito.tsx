...
import type ProductoCredito from "../models/ProductoCredito.model";

export default function ListProductoCredito() {
  const { entidades, cargando } =
    useEntidades<ProductoCredito>("/ProductoCredito");

  const columns: MRT_ColumnDef<ProductoCredito>[] = [
