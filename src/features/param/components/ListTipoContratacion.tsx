...
import type TipoContratacion from "../models/TipoContratacion.model";
import { MaterialReactTable, type MRT_ColumnDef } from "material-react-table";
import { Button, Card, Typography } from "@mui/material";

export default function ListTipoContratacion() {
  const { entidades, cargando } =
    useEntidades<TipoContratacion>("/TipoContratacion");

  const columns: MRT_ColumnDef<TipoContratacion>[] = [
    {
      accessorKey: "Codigo",
      header: "Código",
      size: 120,
