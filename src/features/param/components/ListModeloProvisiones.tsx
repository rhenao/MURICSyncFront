...
import type ModeloProvisiones from "../models/ModeloProvisiones.model";
import { MaterialReactTable, type MRT_ColumnDef } from "material-react-table";
import { Button, Card, Typography } from "@mui/material";

export default function ListModeloProvisiones() {
  const { entidades, cargando } =
    useEntidades<ModeloProvisiones>("/ModeloProvisiones");

  const columns: MRT_ColumnDef<ModeloProvisiones>[] = [
    {
      accessorKey: "Codigo",
      header: "Código",
      size: 120,
