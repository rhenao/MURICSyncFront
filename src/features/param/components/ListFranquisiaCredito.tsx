...
import type FranquisiaCredito from "../models/FranquisiaCredito.model";
import { MaterialReactTable, type MRT_ColumnDef } from "material-react-table";
import { Button, Card, Typography } from "@mui/material";

export default function ListFranquisiaCredito() {
  const { entidades, cargando } =
    useEntidades<FranquisiaCredito>("/FranquisiaCredito");

  const columns: MRT_ColumnDef<FranquisiaCredito>[] = [
    {
      accessorKey: "Codigo",
      header: "Código",
      size: 120,
