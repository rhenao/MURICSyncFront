...
import type CalidadDeudor from "../models/CalidadDeudor.model";
import { MaterialReactTable, type MRT_ColumnDef } from "material-react-table";
import { Button, Card, Typography } from "@mui/material";

export default function ListCalidadDeudor() {
  const { entidades, cargando } = useEntidades<CalidadDeudor>("/CalidadDeudor");

  const columns: MRT_ColumnDef<CalidadDeudor>[] = [
    {
      accessorKey: "Codigo",
      header: "Código",
      size: 280,
