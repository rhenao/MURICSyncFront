...
import type CanalOriginacion from "../models/CanalOriginacion.model";
import { MaterialReactTable, type MRT_ColumnDef } from "material-react-table";
import { Button, Card, Typography } from "@mui/material";

export default function ListCanalOriginacion() {
  const { entidades, cargando } = useEntidades<CanalOriginacion>("/CanalOriginacion");

  const columns: MRT_ColumnDef<CanalOriginacion>[] = [
    {
      accessorKey: "Codigo",
      header: "Código",
      size: 280,
