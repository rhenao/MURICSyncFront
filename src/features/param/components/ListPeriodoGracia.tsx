...
import type PeriodoGracia from "../models/PeriodoGracia.model";
import { MaterialReactTable, type MRT_ColumnDef } from "material-react-table";
import { Button, Card, Typography } from "@mui/material";

export default function ListPeriodoGracia() {
  const { entidades, cargando } = useEntidades<PeriodoGracia>("/PeriodoGracia");

  const columns: MRT_ColumnDef<PeriodoGracia>[] = [
    {
      accessorKey: "Codigo",
      header: "Código",
      size: 120,
