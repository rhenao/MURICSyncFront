...
import type PlazoCredito from "../models/PlazoCredito.model";

export default function ListPlazoCredito() {
  const { entidades, cargando } = useEntidades<PlazoCredito>("/PlazoCredito");

  const columns: MRT_ColumnDef<PlazoCredito>[] = [
