...
import type CalificacionCredito from "../models/CalificacionCredito.model";
import { MaterialReactTable, type MRT_ColumnDef } from "material-react-table";
import { Button, Card, Typography } from "@mui/material";

export default function ListCalificacionCredito() {
  const { entidades, cargando } = useEntidades<CalificacionCredito>(
    "/CalificacionCredito"
  );

  const columns: MRT_ColumnDef<CalificacionCredito>[] = [
    {
      accessorKey: "Codigo",
      header: "Código",
      size: 120,
